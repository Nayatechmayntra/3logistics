...
import 'package:erp_project/modal/home_model.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  late CustomTimerController checkIntimecontroller = CustomTimerController(
      ...
      begin: Duration(
        seconds: int.parse(
            homeController.homeDatalist[0].productiveTimeArr!.s.toString()),
        minutes: int.parse(
            homeController.homeDatalist[0].productiveTimeArr!.i.toString()),
        hours: int.parse(
            homeController.homeDatalist[0].productiveTimeArr!.h.toString()),
      ),
  ...
  late CustomTimerController breakIntimecontroller = CustomTimerController(
      ...
      begin: Duration(
          seconds: int.parse(
              homeController.homeDatalist[0].breakTimeArray!.s.toString()),
          minutes: int.parse(
              homeController.homeDatalist[0].breakTimeArray!.i.toString()),
          hours: int.parse(
              homeController.homeDatalist[0].breakTimeArray!.h.toString())),
      end: const Duration(minutes: 60),
      initialState: CustomTimerState.reset,
      interval: CustomTimerInterval.milliseconds);
  ...
  late CustomTimerController totaltimecontroller = CustomTimerController(
      ...
      begin: Duration(
          seconds: int.parse(
              homeController.homeDatalist[0].totalTimeArray!.s.toString()),
          minutes: int.parse(
              homeController.homeDatalist[0].totalTimeArray!.i.toString()),
          hours: int.parse(
              homeController.homeDatalist[0].totalTimeArray!.h.toString())),
      ...
      child: WillPopScope(
        ...
        child: SafeArea(
          ...
          body: Stack(children: <Widget>[
            ...
            Container(
                child: Obx(
              () => homeController.homeDatalist.length > 0
                                        ...
                                        children: [
                                          Padding(
                                            padding:
                                                const EdgeInsets.only(top: 8.0),
                                            child: Image.asset(
                                                'assets/breakinicon.png'),
                                          ),
                                          InkWell(
                                            onTap: () async {
                                              if(isInTime==true){
                                                showSnackBar(
                                                    context, "Please check In");
                                              }else{
                                                showBreakPopup();
                                              }
                                            },
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (isOnline) {
                                    ...
                                    await currentlocationController.startNavigationApi(token!);

                                    showSnackBar(
                                        context, "Started a GPS Navigation");
                                  } else {
                                    Get.snackbar(
                                  ...
                                  print("isStartNavigation clicked...");
                                },
                                child: Visibility(
                                  visible: isStartNavigation,
                                  child: Center(
                                    child: Container(
                                      height: 35.h,
                                      width: 180.h,
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  if (isOnline) {
                                    _stopForegroundTask();
                                    await currentlocationController.stopNavigationtApi(token!);
                                    showSnackBar(
                                        context, "Stoped a GPS Navigation");
                                  } else {
                                    Get.snackbar(
                                        "Error", "Internet not available");
                                  }
                                  ...
                                  print("isStopNavigation clicked...");
                                },
                                child: Visibility(
                                  visible: isStopNavigation,
                                  child: Center(
                                    child: Container(
                                      height: 35.h,
                                      width: 180.h,
  ...
  Future<bool> showBreakPopup() async {
    return await showDialog(
          //show confirm dialogue
          //the return value will be from "Yes" or "No" options
          context: context,
          builder: (context) => AlertDialog(
            ...
            content: const Text('Do you want to take a break?'),
            actions: [
              ElevatedButton(
                onPressed: () => Navigator.of(context).pop(false),
                //return false when click on "NO"
