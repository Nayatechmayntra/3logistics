...
class BreakInController extends GetxController{
  ...
  breakInApi(String token) async {
    ...
    Webservice().loadPostWithToken(getbreakInApi, map, token).then(
          (model) => {
        print("Token::::::${token}"),
  ...
  Resource<Breakin> get getbreakInApi {
    return Resource(
        url: ApiString.breakin,
        parse: (response) {
          var result;
